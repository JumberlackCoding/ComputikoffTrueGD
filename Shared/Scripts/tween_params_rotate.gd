...
@export_range(-360, 360, 0.1, "or_greater", "or_less", "prefer_slider", "suffix:degrees", "radians_as_degrees") var start: float = 0.0 ## Default [code]0.0[/code]
@export_range(-360, 360, 0.1, "or_greater", "or_less", "prefer_slider", "suffix:degrees", "radians_as_degrees") var end: float = 0.0 ## Default [code]0.0[/code]
